...
namespace PROProtocol
{
    public class TradePokemon
    {
        ...
        internal TradePokemon(string[] data)
        {
            ...
            Moves[0] = new PokemonMove(1, Convert.ToInt32(data[21]));
            Moves[1] = new PokemonMove(2, Convert.ToInt32(data[22]));
            Moves[2] = new PokemonMove(3, Convert.ToInt32(data[23]));
            Moves[3] = new PokemonMove(4, Convert.ToInt32(data[24]));
